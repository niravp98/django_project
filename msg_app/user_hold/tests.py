...
from msg_control.tests import create_image, SimpleUploadedFile
...
class TestUserInfo(APITestCase):
    ...
    def test_post_user_profile(self):
        ...
        self.assertEqual(response.status_code, 201)
        self.assertEqual(result["first_name"], "Nirav")
        self.assertEqual(result["last_name"], "Patil")
        self.assertEqual(result["user"]["username"], "niravpatil")
    ...
    def test_user_search(self):
        ...
        self.assertEqual(result[0]["user"]["username"], "adefemigreat")
