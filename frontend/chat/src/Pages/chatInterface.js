...
function ChatInterface(props) {
  ...
  // const deleteMessage = async (message_ids) => {
  //   const token = await getToken()
  //   axiosHandler({method:"delete", url:DELETE_MESSAGE_URL, token, data:{message_ids}})
  //   dispatch({})
  // }
  ...
  // to show if the users are active
  useEffect(() => {
    if(activeChat){
      getMessages();
